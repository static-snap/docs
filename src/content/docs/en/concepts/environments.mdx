...
import environmentsList from '~/assets/screenshots/environments/environments-list.png';

<Image src={environmentsList} alt="Environments List" width={600} height={400} />
